...
function Paket() {
    return (
        ...
        <div className='w-full bg-blue-400 rounded-lg p-2 my-5 justify-center cursor-pointer shadow duration-150 hover:scale-105 hover:shadow-md'>
            ...
            <p className='px-2 pt-2 text-2xl font-bold text-white'>Paket Bulanan</p>
            ...
            <li className='text-white'>Harga berlaku untuk cuci setrika dan antar jemput max 18 Kg (jika lebih dr 18 kg, maka ada tambahan 5.5k/kg) </li>
