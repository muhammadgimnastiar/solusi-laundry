  ...
  return (
    <div className="bg-bg pt-10">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col justify-center items-center bg-blue-900 rounded-lg p-2 h-20  cursor-pointer shadow duration-150 hover:scale-105 hover:shadow-md">
          ...
          <div className="flex flex-col items-start">
            ...
            <ul className="list-disc flex flex-col px-10 pt-10 pb-5 items-start">
              <li className="text-white">
                Harga berlaku untuk cuci setrika dan antar jemput max 18 Kg
                (jika lebih dr 18 kg, maka ada tambahan 5.5k/kg){" "}
              </li>
              <li className="text-white">Harga berlaku per orang</li>
              <li className="text-white">
                Paket tidak temasuk selimut, seprei, bed cover, sepatu, tas,
                topi
              </li>
