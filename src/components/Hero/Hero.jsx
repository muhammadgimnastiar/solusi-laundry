          ...
          <div className="col-span-12 lg:col-span-7 order-2 lg:order-1 ">
            <div className="justify-center xl:justify-start">
              ...
              <h5 className="font-inter text-base mt-4 mb-8 lg:mt-12 lg-mb-20 text-center lg:text-start">
                Solusi Laundry hadir sebagai laundry service yang memahami dan
                siap membantu segala kebutuhan anda tentang laundry dengan
                selalu mengutamakan kualitas dengan pelayanan yang ramah serta
                profesional bekerja sesuai SOP (Standard Operating Procedures)
              </h5>
            </div>
